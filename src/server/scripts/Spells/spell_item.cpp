...
<<<<<<< HEAD
class spell_1h_swords_tome : public SpellScriptLoader
{
public:
	spell_1h_swords_tome() : SpellScriptLoader("spell_1h_swords_tome") { }

	class spell_1h_swords_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_1h_swords_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(43, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_1h_swords_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_1h_swords_tome_SpellScript();
	}
};

class spell_2h_swords_tome : public SpellScriptLoader
{
public:
	spell_2h_swords_tome() : SpellScriptLoader("spell_2h_swords_tome") { }

	class spell_2h_swords_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_2h_swords_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(55, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_2h_swords_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_2h_swords_tome_SpellScript();
	}
};

class spell_1h_maces_tome : public SpellScriptLoader
{
public:
	spell_1h_maces_tome() : SpellScriptLoader("spell_1h_maces_tome") { }

	class spell_1h_maces_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_1h_maces_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(54, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_1h_maces_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_1h_maces_tome_SpellScript();
	}
};

class spell_2h_maces_tome : public SpellScriptLoader
{
public:
	spell_2h_maces_tome() : SpellScriptLoader("spell_2h_maces_tome") { }

	class spell_2h_maces_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_2h_maces_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(160, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_2h_maces_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_2h_maces_tome_SpellScript();
	}
};

class spell_1h_axes_tome : public SpellScriptLoader
{
public:
	spell_1h_axes_tome() : SpellScriptLoader("spell_1h_axes_tome") { }

	class spell_1h_axes_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_1h_axes_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(44, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_1h_axes_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_1h_axes_tome_SpellScript();
	}
};

class spell_2h_axes_tome : public SpellScriptLoader
{
public:
	spell_2h_axes_tome() : SpellScriptLoader("spell_2h_axes_tome") { }

	class spell_2h_axes_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_2h_axes_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(172, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_2h_axes_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_2h_axes_tome_SpellScript();
	}
};

class spell_bows_tome : public SpellScriptLoader
{
public:
	spell_bows_tome() : SpellScriptLoader("spell_bows_tome") { }

	class spell_bows_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_bows_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(45, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_bows_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_bows_tome_SpellScript();
	}
};

class spell_guns_tome : public SpellScriptLoader
{
public:
	spell_guns_tome() : SpellScriptLoader("spell_guns_tome") { }

	class spell_guns_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_guns_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(46, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_guns_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_guns_tome_SpellScript();
	}
};

class spell_staves_tome : public SpellScriptLoader
{
public:
	spell_staves_tome() : SpellScriptLoader("spell_staves_tome") { }

	class spell_staves_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_staves_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(136, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_staves_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_staves_tome_SpellScript();
	}
};

class spell_defense_tome : public SpellScriptLoader
{
public:
	spell_defense_tome() : SpellScriptLoader("spell_defense_tome") { }

	class spell_defense_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_defense_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(95, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_defense_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_defense_tome_SpellScript();
	}
};

class spell_unarmed_tome : public SpellScriptLoader
{
public:
	spell_unarmed_tome() : SpellScriptLoader("spell_unarmed_tome") { }

	class spell_unarmed_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_unarmed_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(162, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_unarmed_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_unarmed_tome_SpellScript();
	}
};

class spell_daggers_tome : public SpellScriptLoader
{
public:
	spell_daggers_tome() : SpellScriptLoader("spell_daggers_tome") { }

	class spell_daggers_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_daggers_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(173, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_daggers_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_daggers_tome_SpellScript();
	}
};

class spell_thrown_weapons_tome : public SpellScriptLoader
{
public:
	spell_thrown_weapons_tome() : SpellScriptLoader("spell_thrown_weapons_tome") { }

	class spell_thrown_weapons_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_thrown_weapons_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(176, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_thrown_weapons_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_thrown_weapons_tome_SpellScript();
	}
};

class spell_crossbows_tome : public SpellScriptLoader
{
public:
	spell_crossbows_tome() : SpellScriptLoader("spell_crossbows_tome") { }

	class spell_crossbows_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_crossbows_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(226, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_crossbows_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_crossbows_tome_SpellScript();
	}
};

class spell_wands_tome : public SpellScriptLoader
{
public:
	spell_wands_tome() : SpellScriptLoader("spell_wands_tome") { }

	class spell_wands_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_wands_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(228, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_wands_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_wands_tome_SpellScript();
	}
};

class spell_polearms_tome : public SpellScriptLoader
{
public:
	spell_polearms_tome() : SpellScriptLoader("spell_polearms_tome") { }

	class spell_polearms_tome_SpellScript : public SpellScript
	{
		PrepareSpellScript(spell_polearms_tome_SpellScript);

		void HandleDummy(SpellEffIndex)
		{
			Player* target = GetHitPlayer()->ToPlayer();
			target->UpdateSkill(229, 10);
		}

		void Register() override
		{
			OnEffectHitTarget += SpellEffectFn(spell_polearms_tome_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
		}
	};

	SpellScript* GetSpellScript() const override
	{
		return new spell_polearms_tome_SpellScript();
	}
=======
...
>>>>>>> ab413a019d2af4ed65f5a2116651be97762d1b31
};
...
<<<<<<< HEAD
	...
	new spell_1h_swords_tome();
	new spell_2h_swords_tome();
	new spell_1h_axes_tome();
	new spell_2h_axes_tome();
	new spell_1h_maces_tome();
	new spell_2h_maces_tome();
	new spell_daggers_tome();
	new spell_polearms_tome();
	new spell_staves_tome();
	new spell_wands_tome();
	new spell_bows_tome();
	new spell_guns_tome();
	new spell_crossbows_tome();
